...
How to add parts to book?

Data structure ipsum laboris deserunt ea incididunt sit ea amet ullamco nulla aute laboris. Nisi ad commodo qui esse exercitation non. Nostrud laboris duis proident reprehenderit dolor. Excepteur cillum aliquip qui proident.



After reading this chapter, the reader should understand the definition of a heap, stack, and queue, what they’re used for in computer science, and what kinds of questions to expect. 
...
While this book assumes you've had an introduction to computer programming, this chapter will contain an exploration of some basic concepts in order to create a baseline of understanding for the content to follow.
...
If you're watching a movie and you see a chattering machine spitting out the urgent message onto a sheet of paper that needs to be seen immediately by a spy or government, that's a teletype machine.
...
I will revisit the construction of some of these functions in the upcoming "Arrays" chapter, but hopefully this has helped you start to the importance of these basic string manipulation issues and why they might come up in programming tests. 
