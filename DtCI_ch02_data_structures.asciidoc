...
These functions are also inside of the programming languages because they're so often used, and this means they're the basis for a lot of programming interview questions.
So download the source, dig through the source code, read the spec, and above all else, program them yourself!
====
