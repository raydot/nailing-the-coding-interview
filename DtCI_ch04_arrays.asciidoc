...
The player is given a 9x9 grid of squares that is futher subdivided into 9 3x3 grids of squares.
...
[picture 1-D and 2-D representations of tic-tac-toe boards]
...
A computer has no way of knowing how to play tic-tac-toe, of course, and so doesn't know what a winning move looks like.  Here is a two-dimensional list of the winning moves by list, column, and diagonal:
