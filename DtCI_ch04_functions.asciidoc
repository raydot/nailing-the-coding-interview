...
While there are many ways to define and describe functions I've never heard on more accurate than "functions are the building blocks of code."  
Functions are a primary and essential part of coding that you should absolutely expect to be asked about in a coding interview. 
