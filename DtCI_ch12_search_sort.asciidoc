...
Keep in mind this is an educational, fits-in-a-book example, so consider it a starting place for your own futher explorations. 
Try integrating it with the c
